...
from src.optimizer.chair.tink_opt import TinkOptimizer
...
optimizer = TinkOptimizer("/mnt/d/datasets/sscf/ckpts/chair/tink.ckpt",vnndif_path='/mnt/d/datasets/sscf/ckpts/chair/checkpoint.ckpt')
...
save_folder = f'results/tink/chair'
