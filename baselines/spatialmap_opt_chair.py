...
from src.optimizer.chair.spatialmap_opt import SpatialMapOptimizer
...
optimizer = SpatialMapOptimizer('/mnt/d/datasets/sscf/ckpts/chair/checkpoint.ckpt')
...
save_folder = f'results/spatialmap/chair'
...
for i_src in src_list:
    ...
    O_src_g0 = dataset_src.get_mesh_g0(i_src)
    O_tgt_g0 = dataset_tgt.get_mesh_g0(i_tgt)
    O_src_tet = dataset_src.get_mesh_tet(i_src)

    # transfer
    out_dict = optimizer.transfer(H_src_param, O_src, O_tgt, O_src_g0, O_tgt_g0, O_src_tet)
