...
from src.optimizer.chair.cpd_opt import CPDOptimizer
...
optimizer = CPDOptimizer('/mnt/d/datasets/sscf/ckpts/chair/checkpoint.ckpt')
...
save_folder = f'results/cpd/chair'
