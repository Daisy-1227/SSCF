...
from src.optimizer.mug.tink_opt import TinkOptimizer
...
optimizer = TinkOptimizer("/mnt/d/datasets/sscf/ckpts/mug/tink.ckpt",vnndif_path='/mnt/d/datasets/sscf/ckpts/mug/checkpoint.ckpt')
...
save_folder = f'results/tink/mug'
