...
def save_result(human_pose=None, human_betas=None, human_transl=None, human_orient=None, object_rotation=None, object_location=None, joint_prox=None, object_id=None, rigid=False, show_axis=False, voxel_n=0, extra_meshes=[], save_name='', return_img=False, show=True,object_root_location=None,object_root_rotation=None):
    if human_pose is not None:
        model = smplx.create('/mnt/d/datasets/sscf/human_model/smplx', model_type='smplx',
                             gender='male', ext='npz',
                             num_betas=10,
                             use_pca=False,
        ...
        human_mesh = trimesh.Trimesh(vertices=vertices, faces=model.faces,process=False)
    ...
    return torch_param,human_mesh,object_mesh



def visualize_result(human_pose=None, human_betas=None, human_transl=None, human_orient=None, object_rotation=None, object_location=None, joint_prox=None, object_id=None, rigid=False, show_axis=False, voxel_n=0, extra_meshes=[], save_name='', return_img=False, show=True,object_root_location=None,object_root_rotation=None):
    ...
    if human_pose is not None:
        model = smplx.create('../../smplx', model_type='smplx',
                             gender='male', ext='npz',
                             num_betas=10,
                             use_pca=False,
                             create_global_orient=True,
